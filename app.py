...
app = Flask(__name__)
# تفعيل CORS على مستوى السيرفر بالكامل
CORS(app)
...
def get_headers(ua, ref):
    # يوزر إيجنت قوي جداً لتخطي حمايات السيرفرات القوية
...
# ==========================================
# 🔥 1. البروكسي الشبح (لمشغل الشاكا فقط) لكسر CORS و Referer 🔥
# ==========================================
...
def shaka_proxy():
    ...
    # تمرير طلبات تقطيع الفيديو بدقة عشان ما يقطع
    ...
    try:
        ...
        # الطلقة السحرية لكسر حماية متصفح الـ WebView الإجبارية
...
# ==========================================
# 🔥 2. بروكسي الـ M3U8 العادي (لمشغل App24 الخارجي) 🔥
# ==========================================
